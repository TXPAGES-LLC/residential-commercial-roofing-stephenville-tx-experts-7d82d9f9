...
const areaGroups = [
  {
    ...
    cities: [
      { city: 'Stephenville', state: 'TX', href: '/near/stephenville-tx' },
      { city: 'Dublin', state: 'TX', href: '/near/dublin-tx' },
      { city: 'Hico', state: 'TX', href: '/near/hico-tx' },
      { city: 'Eastland', state: 'TX', href: '/near/eastland-tx' },
      { city: 'De Leon', state: 'TX', href: '/near/de-leon-tx' },
    ],
  },
  {
    label: 'Granbury Area',
    ...
    cities: [
      { city: 'Granbury', state: 'TX', href: '/near/granbury-tx' },
      { city: 'Glen Rose', state: 'TX', href: '/near/glen-rose-tx' },
      { city: 'Weatherford', state: 'TX', href: '/near/weatherford-tx' },
      { city: 'Mineral Wells', state: 'TX', href: '/near/mineral-wells-tx' },
    ],
  },
  {
    ...
    cities: [
      { city: 'Brownwood', state: 'TX', href: '/near/brownwood-tx' },
      { city: 'Hamilton', state: 'TX', href: '/near/hamilton-tx' },
      { city: 'Goldthwaite', state: 'TX', href: '/near/goldthwaite-tx' },
      { city: 'Comanche', state: 'TX', href: '/near/comanche-tx' },
      { city: 'Santa Anna', state: 'TX', href: '/near/santa-anna-tx' },
      { city: 'Coleman', state: 'TX', href: '/near/coleman-tx' },
      { city: 'Bangs', state: 'TX', href: '/near/bangs-tx' },
    ],
  },
]
