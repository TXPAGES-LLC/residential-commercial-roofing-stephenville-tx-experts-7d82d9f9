...
const areaGroups = [
  {
    ...
    phone: '254-968-7663',
    cities: [
      { label: 'Stephenville', href: '/near/stephenville-tx' },
      { label: 'Dublin', href: '/near/dublin-tx' },
      { label: 'Hico', href: '/near/hico-tx' },
      { label: 'Eastland', href: '/near/eastland-tx' },
      { label: 'De Leon', href: '/near/de-leon-tx' },
    ],
  },
  {
    label: 'Granbury Area',
    phone: '817-573-0890',
    cities: [
      { label: 'Granbury', href: '/near/granbury-tx' },
      { label: 'Glen Rose', href: '/near/glen-rose-tx' },
      { label: 'Weatherford', href: '/near/weatherford-tx' },
      { label: 'Mineral Wells', href: '/near/mineral-wells-tx' },
    ],
  },
  {
    ...
    phone: '325-510-5768',
    cities: [
      { label: 'Brownwood', href: '/near/brownwood-tx' },
      { label: 'Hamilton', href: '/near/hamilton-tx' },
      { label: 'Goldthwaite', href: '/near/goldthwaite-tx' },
      { label: 'Comanche', href: '/near/comanche-tx' },
      { label: 'Santa Anna', href: '/near/santa-anna-tx' },
      { label: 'Coleman', href: '/near/coleman-tx' },
      { label: 'Bangs', href: '/near/bangs-tx' },
    ],
  },
]
